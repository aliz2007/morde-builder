...
`companion/` is an Electron app that puts the same 139 matchups inside the League
client. At champ select you click whichever enemy you think is going top; it
creates that matchup's rune page, saves the build as an in-shop item set, and can
set your summoner spells. In game a small always-on-top card shows the build
order and the tips, and follows the real enemy top laner once the game knows who
that is.
